        ...
        <div className={className} {...rest}>
            <div className="container border-bottom pt-12 pb-16">
                    ...
                    <div className="col-lg-6 col-md-9 col-sm-11 font-weight-500">
                        ...
                        >
                            ...
                            <div className="mt-8 mb-8">
                                ...
                                &nbsp; &nbsp;&nbsp;
                                <button onClick={() => purchase('prod_KcuPPyG5tMjg6O')} className="btn btn-dark-green btn-4 pt-3 p-2 rounded-5" style={{ background: 'linear-gradient(180deg, #000000 32.81%, #39B54A 100%)', borderColor: '#39B54A' }}>
                                    $100 card for $50 <br />
                                    BUY NOW
                                </button>
                            </div>
                ...
                <div className="mt-10 text-center">
                    <a href="#" target="_blank" className="btn btn-black btn-3 rounded-5">
                        Visit website
                    </a>
                </div>
            </div>
